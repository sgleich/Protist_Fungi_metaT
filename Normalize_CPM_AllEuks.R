### Protist + Fungi MetaT - Library Normalization and CPM Calculation All Eukaryotes ###
### This script will normalize and calculate the CPM of the decomposition experiment metaT data to use in downstream analyses. ###
### Updated: May 11, 2024 ###
...
write.csv(dfFin,"CPM_AllEuk.csv")
